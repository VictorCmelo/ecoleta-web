...
const CreatePoint = () => {
  ...
  const [initianPosition, setInitianPosition] = useState<[number, number]>([0,0 ]);
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(position =>{
      ...
      setInitianPosition([latitude, longitude]);
    });
  },[])
  ...
  return (
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Map center={initianPosition} zoom={15} onClick={handleMapClick}>
          <TileLayer 
